...
window.PARTY_COPY = {
  ...
  en: {
    ...
    'nav.upload': 'Upload your pictures',
    'nav.upload.short': 'Upload',
    ...
    'photos.mine.open.video': 'Play your video {i}',
    ...
    'enrol.form.guests.solo': 'Just me',
    'enrol.form.guests.plus': 'Me +{n}',
    ...
    'photos.status.waiting': 'Still waiting for the phone to hand over file {i} of {n}',
    'photos.status.uploading': 'Sending {i} of {n}',
    'photos.status.done.one': 'One photograph is on record.',
    'photos.status.done.video.one': 'The video is on record.',
    'photos.status.done.video.many': '{n} videos are on record.',
    'photos.status.done.mixed': '{n} submissions are on record.',
    ...
    'photos.err.type': 'Not a picture or a video ({kind})',
    'photos.err.unknownkind': 'unknown type',
    'photos.err.video.off': 'Video is not being accepted yet',
    'photos.err.video.format': 'This video format is not accepted ({kind}). Film it with the phone camera rather than forwarding it from somewhere else.',
    'photos.err.video.size': 'Over {mb} MB. Film it again at a lower quality, or send a shorter piece of it.',
    'photos.err.video.long': 'Longer than {n} seconds',
    'photos.err.video.read': 'Your browser could not open this video ({kind}).',
    'photos.err.video.only': 'One video each. You have already sent yours.',
    'photos.err.size': 'Larger than {mb} MB',
    'photos.err.empty': 'The file is empty',
    'photos.err.decode': 'Your browser could not open this image ({kind}). If it came from an iPhone, try sending it from the photo album rather than from Files.',
    'photos.err.unreadable': 'The phone did not hand over this file. Pick it again through a different app, such as Files or the gallery, and make sure it has been downloaded to the phone.',
    ...
    'photos.refuse.video': 'The register already holds a video in your name. This one was not added, and your photographs are unaffected.',
    ...
    'photos.pick.files': 'Choose through Files instead',
  ...
  it: {
    ...
    'nav.upload': 'Carica le tue foto',
    'nav.upload.short': 'Carica',
    ...
    'photos.mine.open.video': 'Riproduci il tuo video {i}',
    ...
    'enrol.form.guests.solo': 'Solo io',
    'enrol.form.guests.plus': 'Io +{n}',
    ...
    'photos.status.waiting': 'In attesa che il telefono consegni il file {i} di {n}',
    'photos.status.uploading': 'Invio {i} di {n}',
    'photos.status.done.one': 'Una fotografia è agli atti.',
    'photos.status.done.video.one': 'Il video è agli atti.',
    'photos.status.done.video.many': '{n} video sono agli atti.',
    'photos.status.done.mixed': '{n} consegne sono agli atti.',
    ...
    'photos.err.type': 'Non è una foto né un video ({kind})',
    'photos.err.unknownkind': 'tipo sconosciuto',
    'photos.err.video.off': 'I video non si accettano ancora',
    'photos.err.video.format': 'Questo formato video non si accetta ({kind}). Giralo con la fotocamera del telefono invece di inoltrarlo da altrove.',
    'photos.err.video.size': 'Oltre {mb} MB. Rigiralo a qualità più bassa, o mandane un pezzo più corto.',
    'photos.err.video.long': 'Più lungo di {n} secondi',
    'photos.err.video.read': 'Il browser non è riuscito ad aprire questo video ({kind}).',
    'photos.err.video.only': 'Un video a testa. Il tuo lo hai già mandato.',
    'photos.err.size': 'Più di {mb} MB',
    'photos.err.empty': 'Il file è vuoto',
    'photos.err.decode': 'Il browser non è riuscito ad aprire questa immagine ({kind}). Se arriva da un iPhone, prova a mandarla dall’album foto invece che da File.',
    'photos.err.unreadable': 'Il telefono non ha consegnato questo file. Sceglilo di nuovo da un’altra app, per esempio File o la galleria, e assicurati che sia scaricato sul telefono.',
    ...
    'photos.refuse.video': 'Il registro ha già un video a tuo nome. Questo non è stato aggiunto, e le tue foto non cambiano.',
    ...
    'photos.pick.files': 'Scegli tramite File',
  ...
  da: {
    ...
    'nav.upload': 'Upload dine billeder',
    'nav.upload.short': 'Upload',
    ...
    'photos.mine.open.video': 'Afspil din video {i}',
    ...
    'enrol.form.guests.solo': 'Kun mig',
    'enrol.form.guests.plus': 'Mig +{n}',
    ...
    'photos.status.waiting': 'Venter stadig på at telefonen udleverer fil {i} af {n}',
    'photos.status.uploading': 'Sender {i} af {n}',
    'photos.status.done.one': 'Ét fotografi er registreret.',
    'photos.status.done.video.one': 'Videoen er registreret.',
    'photos.status.done.video.many': '{n} videoer er registreret.',
    'photos.status.done.mixed': '{n} afleveringer er registreret.',
    ...
    'photos.err.type': 'Hverken et billede eller en video ({kind})',
    'photos.err.unknownkind': 'ukendt type',
    'photos.err.video.off': 'Video tages ikke imod endnu',
    'photos.err.video.format': 'Dette videoformat tages ikke imod ({kind}). Optag den med telefonens kamera i stedet for at sende den videre fra et andet sted.',
    'photos.err.video.size': 'Over {mb} MB. Optag den igen i lavere kvalitet, eller send et kortere stykke.',
    'photos.err.video.long': 'Længere end {n} sekunder',
    'photos.err.video.read': 'Din browser kunne ikke åbne denne video ({kind}).',
    'photos.err.video.only': 'Én video hver. Din har du allerede sendt.',
    'photos.err.size': 'Større end {mb} MB',
    'photos.err.empty': 'Filen er tom',
    'photos.err.decode': 'Din browser kunne ikke åbne dette billede ({kind}). Kommer det fra en iPhone, så prøv at sende det fra billedalbummet i stedet for fra Filer.',
    'photos.err.unreadable': 'Telefonen udleverede ikke denne fil. Vælg den igen fra en anden app, for eksempel Filer eller galleriet, og sørg for at den er hentet ned på telefonen.',
    ...
    'photos.refuse.video': 'Registret har allerede en video i dit navn. Denne blev ikke tilføjet, og dine billeder er uberørte.',
    ...
    'photos.pick.files': 'Vælg via Filer i stedet',
