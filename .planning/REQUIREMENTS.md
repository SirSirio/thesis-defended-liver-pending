...
Added 2026-08-13 at the owner's request. A countdown tells a guest how long they
have. It does not tell them what to write in their calendar, and it disappears the
moment they close the tab. This section closes that gap.
...
- [x] **ACC-05**: With no video file present, the section shows a clear placeholder rather than a broken player
